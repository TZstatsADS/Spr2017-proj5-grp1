...
labs<-c("FG%","X3P%","TRB","AST","STL","BLK")
  ...
  scores<-list(
  "BOS"=as.numeric(radardata[1,1:6]),
  "CHI"=as.numeric(radardata[2,1:6]))
  
  chartJSRadar(scores = scores, labs = labs, scaleStartValue=min(radardata[1,],radardata[2,])+0.01,maxScale = max(radardata[1,],radardata[2,])+0.01)
